...
const messages: Record<UiLocale, Record<string, string>> = {
  'zh-CN': {
    ...
    openclaw_heartbeat_manage_button: '心跳管理',
    openclaw_heartbeat_manage_hint: '心跳管理，长按可直接触发一次心跳提醒',
    openclaw_heartbeat_manage_title: '心跳管理',
  ...
  en: {
    ...
    openclaw_heartbeat_manage_button: 'Heartbeat manager',
    openclaw_heartbeat_manage_hint: 'Heartbeat manager, long press to trigger heartbeat immediately',
    openclaw_heartbeat_manage_title: 'Heartbeat manager',
