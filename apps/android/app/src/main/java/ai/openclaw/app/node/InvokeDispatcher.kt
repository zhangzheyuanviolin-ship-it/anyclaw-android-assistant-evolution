...
class InvokeDispatcher(
  ...
  private val runtimeBridgeHandler: RuntimeBridgeHandler,
  ...
  suspend fun handleInvoke(command: String, paramsJson: String?): GatewaySession.InvokeResult {
    ...
    return when (command) {
      ...
      "runtime.capabilities" -> runtimeBridgeHandler.handleRuntimeCapabilities()
      "system.shell.exec" -> runtimeBridgeHandler.handleSystemShellExec(paramsJson)
      "runtime.ubuntu.exec" -> runtimeBridgeHandler.handleUbuntuExec(paramsJson)
